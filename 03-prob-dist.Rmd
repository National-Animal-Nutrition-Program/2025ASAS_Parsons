...
knitr::include_graphics('docs/figures/03-ConditionalProbability.png')
```

### Total Probability  

```{r totprob, echo=F, fig.cap=''}
knitr::include_graphics('docs/figures/03-TotalProbability.png')
```
...
knitr::include_graphics('docs/figures/03-ChainProbability.png')
``` 
...
knitr::include_graphics('docs/figures/03-JointProb.png')
```
