...
Before installing rjags, we have to install Jags for it to interface with. Refer to [mcmc-jags.sourceforge.io](https://mcmc-jags.sourceforge.io) and download the appropriate files for your machine type and install. Also, refer to the [Jags user manual](https://sourceforge.net/projects/mcmc-jags/) to understand how JAGS works.
